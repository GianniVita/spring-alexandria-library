...
public class BorrowingController {
    ...
    // per fare update dei libri presi in prestito add metodo che restituisca una
    // edit da compilare (con già dati inseriti)
    @GetMapping("/edit/{id}")
    ...
    // metodo che effettui un update vero e proprio(con validazione)
    @PostMapping("/edit/{id}")
